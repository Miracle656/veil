...
The table below summarises key threats at a glance. See the full **[Threat Model](/threat-model)** for the complete STRIDE analysis, attacker model, trust assumptions, and residual risks.
