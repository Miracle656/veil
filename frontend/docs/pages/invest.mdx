...
<Callout type="error">
  **Restricted Persons & Jurisdictions**
  ...
  3. **Unapproved Domestic Markets**: Jurisdictions where offering or arranging transactions in foreign tokenized securities requires local licenses (such as licensing requirements under Nigeria's Securities and Exchange Commission, as discussed in [NGN Rails](/research)).
</Callout>
