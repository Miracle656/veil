 ...
 */
export function deriveCounterfactualAddress(publicKeyBytes, config) {
    const address = computeWalletAddress(config.factoryAddress, publicKeyBytes, config.networkPassphrase);
